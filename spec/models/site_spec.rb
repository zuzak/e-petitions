  ...
  describe "defaults" do
    ...
    describe "for feedback_email" do
      ...
      it "allows overriding via the EPETITIONS_FEEDBACK environment variables" do
        allow(ENV).to receive(:fetch).with("EPETITIONS_FEEDBACK", %{"Petitions: UK Government and Parliament" <petitionscommittee@epetitions.website>}).and_return("petitions@downingstreet.gov.uk")
