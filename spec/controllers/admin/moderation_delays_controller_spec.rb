    ...
    [
      ...
      describe "#{method} #{path}" do
        ...
        it "redirects to the admin profile page" do
          expect(response).to redirect_to("https://test-moderate.epetitions.website:3443/admin/profile/#{moderator.id}/edit")
        end
      end
      ...
      describe "sending a preview email" do
        ...
        context "with valid params" do
          ...
          it "sends an email to the feedback address" do
            expect(email).to deliver_to("petitionscommittee@epetitions.website")
          end
      ...
      describe "sending email to the creators" do
        ...
        context "with valid params" do
          ...
          it "redirects to the overdue petitions page" do
            expect(response).to redirect_to("https://test-moderate.epetitions.website:3443/admin/petitions?state=overdue_in_moderation")
          end
