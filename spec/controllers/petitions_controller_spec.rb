  ...
  describe "GET /petitions/new" do
    ...
    context "when parliament is dissolved" do
      ...
      it "redirects to the home page" do
        get :new
        expect(response).to redirect_to("https://test.epetitions.website:3443/")
      end
    end
  ...
  describe "POST /petitions/new" do
    ...
    context "valid post" do
      ...
      it "should successfully create a new petition and a signature" do
        ...
        expect(response).to redirect_to("https://test.epetitions.website:3443/petitions/#{petition.id}/thank-you")
      end
      ...
      it "should send gather sponsors email to petition's creator" do
        ...
        expect(last_email_sent).to deliver_from(%{"Petitions: UK Government and Parliament" <no-reply@test.epetitions.website>})
    ...
    context "when the petition is archived" do
      ...
      context "and the parliament is archived" do
        ...
        it "redirects to the archived petition page" do
          get :show, id: petition.id
          expect(response).to redirect_to "https://test.epetitions.website:3443/archived/petitions/#{petition.id}"
        end
      end
    end
  end
    ...
    context "when a state param is provided" do
      context "but it is not a public facet from the locale file" do
        it "redirects to itself with state=all" do
          ...
          expect(response).to redirect_to "https://test.epetitions.website:3443/petitions?state=all"
        end

        it "preserves other params when it redirects" do
          get :index, q: "what is clocks", state: "awaiting_monkey"
          expect(response).to redirect_to "https://test.epetitions.website:3443/petitions?q=what+is+clocks&state=all"
        end
      end
